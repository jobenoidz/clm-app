    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center z-50 p-4">
            <div
                ...
                onClick={onClose}
            />
            <div className="relative flex flex-col bg-white rounded-2xl w-full max-w-[60vw]  max-h-[100vh] overflow-auto z-2">
                {/* Modal Body */}
                <div className="p-5">
                    <button
                    ...
                    <div className="flex justify-between">
                        ...
                        <div className="flex flex-col w-[50%] justify-between">
                            <h1 className='text-[4em] leading-[1.2] font-extrabold mb-4'>
                                {client.company_name}
                            </h1>
                            <div className='flex'>
                ...
                {/* Modal Footer */}
                <div className="border-t p-5 flex justify-between space-x-3 sticky bottom-0 bg-[#e7f3ff] z-2 overflow-auto">
                    {/* Left Column */}
                    <div className="space-y-2">
                        <div className="flex gap-4">
                    ...
                    <div className="flex w-[45%]">
                        <div className="space-y-2">
                            ...
                            {availed.map((item: AvailedItem) =>
                                <Button key={item.group_id} className="bg-[#ff802b] text-xl rounded-full hover:bg-[#ff5e00] w-[100%]">
                                    {item.group_name}
                                </Button>
                            )}
                        </div>
