...
export default function AddLeadModal({ onAddLeadClose }) {
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center z-50 p-4">
            ...
            />
            <div className="relative bg-white rounded-2xl w-[70vw] max-h-[90vh] overflow-auto z-10 p-6">
                <h2 className="text-xl mb-4 text-center">Add New Lead</h2>
                <form onSubmit={handleSubmit} className="flex-col gap-5">
                    <div className='flex'>
                        {/* left col */}
                        <div className='w-[50%] bg-orange-50 p-4 space-y-4'>
                            {/* Company Info */}
                            <div className='flex items-center justify-center bg-orange-100'>
                                <div className='flex bg-gray-300 rounded-full p-6'>
                                    <PlusCircle />
                                </div>
                        ...
                        {/* right col */}
                        <div className='w-[50%] bg-green-50 p-4'>
                            <div className=' h-[60vh] overflow-y-auto'>
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        onChange={handleChange}
                                        className="w-full border px-2 py-1 min-h-20"
                                    />
                                </div>
                                <div>
                    ...
                    <div className="flex justify-end space-x-2 bg-pink-50 items-center py-2 pr-4 ">
                        <button
                            type="button"
                            onClick={onAddLeadClose}
